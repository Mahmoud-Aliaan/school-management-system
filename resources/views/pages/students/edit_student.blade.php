                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$student->getTranslation('name', 'ar')}}"  class="form-control" name="name_en" type="text" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{$student->Date_Birth}}" class="form-control" type="text"  id="datepicker-action" name="Date_Birth" data-date-format="yyyy-mm-dd">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Classroom_id" >
                                        <option value="{{$student->classroom->id}}">{{$student->classroom->Class_name}}</option>
                                    </select>
                                </div>
                            </div>

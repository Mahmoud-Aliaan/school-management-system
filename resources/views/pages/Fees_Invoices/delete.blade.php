 ...
 <div class="modal fade" id="Delete_Fee{{ $Fees_Invoice->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p> {{ trans('Accounts_trans.Warning_Delete') }}  {{$Fees_Invoice->Accounts->title}}</p>

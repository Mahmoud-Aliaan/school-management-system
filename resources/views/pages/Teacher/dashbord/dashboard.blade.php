 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0"> {{trans('main_trans.welcame')}} : {{auth()->user()->Name}}</h4>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('student-dashbord.index')}}" target="_blank">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    {{-- <p class="card-text text-dark">ألاقسام</p> --}}
                                    <h4>الاقسام</h4>
                                    <h4>{{$count_sections}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('section')}}" target="_blank">
                                    <span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>

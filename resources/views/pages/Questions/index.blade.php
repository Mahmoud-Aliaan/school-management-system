...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('main_trans.Question_list')}}</h4>
        </div>
        <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete_Quizze{{ $Question->id }}" title="{{ trans('Questions_trans.delete') }}"><i class="fa fa-trash"></i></button>

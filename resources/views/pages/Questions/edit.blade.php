                ...
                <form action="{{route('Questions.update','test')}}" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input id="Name" type="text" name="Name" class="form-control" value="{{$Question->getTranslation('title', 'ar')}}">
                        </div>
                        <div class="col">
                            <label for="Name_en" class="mr-sm-2">{{ trans('Questions_trans.name_en') }}
                                :</label>
                            <input type="text" class="form-control" name="Name_en" value="{{$Question->getTranslation('title', 'en')}}">
                        </div>
                    </div>

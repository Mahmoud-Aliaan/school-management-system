...
public $currentStep = 1,
    ...
    {
         $this->validate([
             'Email' => 'required|unique:my_parints,Email, ' ,
            'Password' => 'required',
            'Name_Father' => 'required',
            'Name_Father_en' => 'required',
            'Job_Father' => 'required',
            'Job_Father_en' => 'required',
            'National_ID_Father' => 'unique:my_parints,National_ID_Father,',
            'Passport_ID_Father' => 'required|unique:my_parints,Passport_ID_Father,',
    ...
    public function secondStepSubmit()
    {
        ...
        $this->validate([
            ...
            // 'National_ID_Mother' => 'unique:my__parents,National_ID_Mother,' ,
        ...
        try {
            ...
            if(!empty($this->photos)){
                foreach($this->photos as $photo){
                    $photo->storeAs($this->Phone_Father,$photo->getClientOriginalName(), $disk = 'parent_attachment');  

                  $pareint=  parentattachment::create([
                    'file_name' => $photo->getClientOriginalName(),
                    'parent_id' => My_parint::latest()->first()->id,
                ]);
            }       
            };          
    ...
    public function edit($id){
        ...
        $My_Parent = My_parint::where('id',$id)->first();
        $this->Parent_id = $id;
    ...
    public function firstStepSubmit_edit()
    {
      ...
      public function submitForm_edit(){
        if($this->Parent_id){
            $parent = My_parint::find($this->Parent_id);
            $parent->update([
        ...
        return redirect()->to('add_parint');
      }

      public function delete($id){
        My_parint::findOrFail($id)->delete();
        return redirect()->to('/add_parint');
      }
